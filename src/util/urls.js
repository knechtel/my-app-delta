...
export var CREATE_EQUIPMENT = `http://1da5-177-74-122-85.sa.ngrok.io/api/equipment`;
...
export var UPDATE_CLIENT = `http://1da5-177-74-122-85.sa.ngrok.io/api/client-update`;
...
export var LOAD_IAMAGE = BASE + "/img/";
